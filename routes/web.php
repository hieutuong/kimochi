...
//    ]);
   ...
   Route::get('mon-ngon', 'HomeController@cook')->name('get.news');
   
   Route::get('gioi-thieu', 'HomeController@career');
   
   Route::get('lien-he', 'HomeController@getContact')->name('get.contact');
